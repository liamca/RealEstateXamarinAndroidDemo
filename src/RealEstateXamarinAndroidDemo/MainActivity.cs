...
namespace RealEstateXamarinAndroidDemo
{
    ...
    public class MainActivity : Activity
    {
        ...
        public static List<ListListing> ListingsForDetails;
        ...
        private async Task<int> ExecMoreLikeThisListingsSearch(string listingIid)
        {
            ...
            foreach (var item in jsonObj["value"])
            {
                ...
                ll.SubText = address;
                ListingsForDetails.Add(ll);
            }

            // Default to the listings list for search results
            ListView lvListings = FindViewById<ListView>(Resource.Id.lvListingsSimilar);
            lvListings.Adapter = new LoadListings(this, ListingsForDetails);
            lvListings.ItemClick += LvListings_ItemClick;
